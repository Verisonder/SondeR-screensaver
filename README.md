...
An Omarchy style fullscreen terminal screensaver for any disto, made with animated ASCII art — built on [terminal-text-effects (tte)](https://github.com/ChrisBuilds/terminaltexteffects) and Alacritty.
